...
export default function Aside() {
  return (
    <aside className="row-start-1 row-end-4 col-start-1 col-end-2 bg-gallery-100 dark:bg-gallery-950 grid transition-[width] duration-300 w-[350px] px-3 border-r-[1px] border-gallery-300">
